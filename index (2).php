...
<body>
<h4>// Resso Player Music Downloader //</h4>
<div style="width:350px" id="search-form_3"> <input style="width:250px" type="text" id="ur" name="url" placeholder="Search Music in resso" class="search_3" required/> <button style="width:70px" id="bt" onclick="loadDoc()" class="submit_3" >Search</button> </div>
